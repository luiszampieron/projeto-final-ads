...
export default async function ClientePage({
  ...
  const cliente = await apiServerJson<Cliente>(`/clientes/${params.id}`)
  ...
  return (
    <section className="row g-4">
      <div className="col-12">
        ...
        <p className="text-muted mb-0">Atualize os dados do cliente e salve as alterações.</p>
      </div>
        ...
        <div className="card surface-card">
          <div className="card-body p-4">
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-start gap-3 mb-4">
              ...
              <Link href="/clientes" className="btn btn-outline-secondary">Voltar para lista</Link>
            </div>
            ...
            <form action={atualizarCliente} className="row g-3 mb-4">
              ...
              <div className="col-12">
                ...
                <input id="nome" name="nome" className="form-control" maxLength={200} defaultValue={cliente.nome} required />
              </div>

              <div className="col-md-6">
                <label htmlFor="documento" className="form-label">Documento</label>
                <input id="documento" name="documento" className="form-control" maxLength={20} defaultValue={cliente.documento ?? ''} />
              </div>
              ...
              <div className="col-md-6">
                ...
                <input id="telefone" name="telefone" className="form-control" maxLength={30} defaultValue={cliente.telefone ?? ''} />
              </div>

              <div className="col-12">
                <label htmlFor="observacoes" className="form-label">Observações</label>
                <textarea id="observacoes" name="observacoes" className="form-control" rows={3} defaultValue={cliente.observacoes ?? ''} />
              </div>
            ...
            <div className="border-top pt-4">
              <form action={removerCliente}>
                <input type="hidden" name="id" value={cliente.id} />
                <button type="submit" className="btn btn-outline-danger">Excluir cliente</button>
              </form>
            </div>
          </div>
        </div>
